...
public class TestDemo {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        //登录设备，每一台设备只需要登录一次
        lUserID = TestDemo.Login_V40("10.17.35.102", (short) 8000, "admin", "abcd1234");
...
//        m_strLoginInfo.byLoginMode=1;  //ISAPI登录
    ...
    //设备在线状态监测
    public void getDeviceStatus(int iUserID) {
...
//        int pInter=Integer.parseInt(pHex);
     ...
     * @param userID
     */
    public static void getRS485Cfg(int iUserID) {
